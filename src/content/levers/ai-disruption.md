...
docType: 'Lever'
families:
  - 'Decision and communication lenses'
tags:
  - 'levers'
  - 'ai'
  - 'guardrails'
...
- research note: [Methods and Sources (AI receipts)](/methods-and-sources/#receipt-group-workplace-ai-governance-and-guardrails)
...
Use AI to reduce the monthly squeeze and administrative drag,
without increasing extraction, opacity, or power concentration.
...
8. Governance lag (`confirmed direction`)
...
6. Market-power and lock-in controls
...
Tripwires are practical economic thresholds, not abstract debates.
The point is simple: change the frame when the labor reality changes, not when the internet mood changes.
...
For safety-critical and rights-impacting use, map controls to applicable law and due-process obligations in the operating jurisdiction.
Use primary standards and primary legal text first, then commentary.
...
- model concepts: [Core Model](/core-model/)
- principles: [About (principles)](/about/)
- accountability standard: [About (principles)](/about/)
- simplicity standard: [About (principles)](/about/)
