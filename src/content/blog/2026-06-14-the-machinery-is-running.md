---
title: 'The Machinery Is Running'
description: 'The same institutional levers that produced state capture elsewhere are being pressed in the United States. Courts are blocking specific mechanisms, but the structural changes keep stacking up.'
pubDate: 2026-06-14
status: 'published'
category: 'democracy'
topics:
...
tags:
  ...
  - 'redistricting'
receiptTags:
  - 'democracy-authoritarian-playbook'
  - 'democracy-us-inspector-general-firings'
sourceChannel: 'economyforeveryone'
oneSmallAction: 'Check whether your state has an independent redistricting commission and find the group working on it before 2030.'
audience:
  - 'general-public'
  - 'civic-advocates'
  - 'policy-advocates'
...
In _Storch v. Hegseth_, a federal judge ruled the firings violated the Inspector General Act. Then he declined to reinstate the IGs. They hadn't shown "irreparable harm," the court said. The law was broken. The court declined to enforce it. The IG workforce declined 16.6% by early 2026.
...
Courts are functioning as veto points. The permanent injunction on the Perkins Coie executive order held. NPR and PBS funding was permanently blocked from cutoff. Federal courts blocked nearly all of the March 2025 election executive order. A federal three-judge panel blocked Alabama's post-_Callais_ redistricting map for intentional racial discrimination in May 2026. Republican-appointed judges ruled against the administration in multiple separate cases on constitutional grounds.
...
- [Winning Is Not Repair](/blog/2026-06-07-winning-is-not-repair/) - winning an election against a captured system doesn't undo the capture; the Hungary, Poland, Slovakia, and Germany cases
- [How Organizing Beat the Fear Machine](/blog/2026-05-31-how-organizing-beat-the-fear-machine/) - what the organizing model looked like in Hungary and why it worked
- [What Hungary Taught Me About American Politics](/blog/2026-06-02-what-hungary-taught-me-about-american-politics/) - the dignity-preserving off-ramp lesson and what transfers to US organizing
- [The Authoritarian Playbook in the United States](/case-studies/authoritarian-playbook-us-levers/) - the full case study with receipts and evidence labels
