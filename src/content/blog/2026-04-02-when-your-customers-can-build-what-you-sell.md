---
title: 'When Your Customers Can Build What You Sell'
description: 'AI can lower the cost of internal tool-building enough that some vendors start losing to their own customers.'
pubDate: 2026-04-02
earlyRelease: true
status: 'published'
category: 'core-model'
...
legacyPostRef: '2-moving-breadbox'
triage: 'promote-to-canonical'
oneSmallAction: 'Pick one internal tool renewal this week and ask whether the comparison is vendor versus vendor or vendor versus an internal build that is now cheap enough to be realistic.'
audience:
  - 'general-public'
  - 'practitioners'
...
One developer with AI help can build most of what they use. An operations lead can fill in some of the workflow pieces with a low-code tool. The remaining gaps are annoying, but not forty-thousand-dollars-a-year annoying.
...
That creates a different market mechanism from normal software competition. The vendor loses more than a deal to another vendor. The buyer can leave the vendor category entirely.
...
That is what makes this different from a normal vendor competition story. The pressure is vendor versus internal build.
...
They may lose more than customers to a stronger rival. They may be losing the entire category of demand.
...
But the story is larger than "fewer starter tasks." Some of the work that moves in-house is bigger, messier, and more formative than the simpler tickets it replaces. In the good version, teams use that opening to bring junior people into internal builds and let them learn on consequential work. In the bad version, seniors and tools absorb both layers at once and the learning path shrinks anyway.
...
It is a world where buyers can make the build-versus-buy choice deliberately, with clear ownership, realistic maintenance assumptions, and documented governance for internal tools.

It is also a world where AI improves the comparison process. Procurement should get better at asking what can be built internally, what should still be bought, and what risks come with each path. That helps buyers avoid lazy renewals and helps smaller vendors compete on value instead of legacy inertia.
...
If you are a technical leader, do not let "we can build it now" become a shortcut around ownership, review, and maintenance. Internal software still needs an accountable steward.
...
"Some software vendors are competing with their own customers' ability to build."

Or:

"AI can change the build-versus-buy threshold without changing the rest of the market. When that happens, vendors lose demand, not only deals."
...
- [Case study: The Moving Breadbox: AI and the Collapsing Build-vs-Buy Threshold](/case-studies/moving-breadbox/)
