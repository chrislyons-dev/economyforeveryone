...
AI has pushed the cost of producing passable content way down. The issue isn't just abundance, but the way abundance raises the importance of ranking systems, discovery systems, and trust signals.
...
The old gate was production. The new gate is discovery. And the new gate is mostly private.

## Why it's happening

The mechanism is simple: output got cheap. Judgment didn't.
...
The flood itself is a problem. But the bigger problem is that low-cost content can imitate the signals people use to decide what is worth trusting:
...
Platforms benefit from more inventory, more engagement opportunities, and more leverage over discovery. Cheap production can also help some small creators enter markets that used to be harder to enter. AI can be a real force for abundance if the gains are shared instead of captured.
...
- readers who can't tell what is real, who is real, or why something is being shown to them
...
The minimum floor here is specific: consumer-facing labels at the point of discovery, real contestability for takedowns and ranking penalties, and calibrated friction that slows flood operations without locking out legitimate creators.

- people should be able to see what they are looking at
...
1. Who made this?
2. Can I verify the source?
3. What trust signal is doing the work here?
4. Would a normal person know what they are looking at?
...
I would say this instead: I'm not anti-AI. I'm pro trust and accountability. The question isn't whether people can make more content. The question is whether normal people can still tell what they are looking at, and whether the systems deciding what gets seen have any meaningful accountability.
