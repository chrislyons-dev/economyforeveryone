...
description: 'Transportation is a stack of unavoidable costs, weak alternatives, and low-choice markets that can make work access feel like a tollbooth.'
pubDate: 2026-03-19
status: 'published'
category: 'big-costs'
topics:
...
legacyPostRef: 'monthly-squeeze-transportation draft'
triage: 'promote-to-canonical'
oneSmallAction: 'Ask: Which rule would reduce transportation captivity fastest here? Do: pick one of these three - all-in pricing, insurance spike review, or fair repair access. Share: send that one ask to a commuter, organizer, or local official.'
audience:
  - 'general-public'
  - 'commuters'
  - 'transportation-policy-readers'
receipts: []
---
...
For a lot of households, transportation is a package of unavoidable costs:
...
When people cannot realistically opt out of driving, the system starts to look like captive demand.
And captive demand attracts extraction:
...
Transportation costs often hit households in bursts.
One repair.
One insurance renewal.
One bad financing contract.
One week of missed work because the car is down.

That volatility matters as much as the monthly average.
Far housing can turn into mandatory car ownership, and mandatory car ownership turns into a deeper squeeze.

For people with flexible money, these are annoying problems.
For people already near the edge, they can become job-loss problems, debt problems, or family-chaos problems.

Transportation is a reliability issue.
...
People get priced by credit, zip code, or similar stand-ins that often track poverty more than driving behavior.

### 2) Dealers and lenders can hide the all-in cost
...
If transit is weak and housing is far from work, switching is not real.
That keeps the household captive.
...
- **All-in pricing:** clear vehicle price, clear financing cost, fewer surprise add-ons
- **Fairer insurance rules:** less proxy pricing, more legible renewals, fewer unexplained spikes
- **Repair contestability:** independent shops can compete
- **Usable alternatives:** enough last-mile, transit, or housing alignment that driving is not the only option
...
- require dealers to show the full out-the-door price and get clear permission before adding extras people did not choose
...
- phase out insurance pricing that relies on credit scores instead of driving risk
...
That keeps the conversation out of the shallow cars bad / transit good lane.
The harder question is whether households have any usable exit from a system that keeps charging them for access to work.
...
- less [usable choice](/core-model/) when work, housing, and daily life all assume the car is mandatory
...
- more [usable choice](/core-model/) because people need more than one realistic way to reach work and daily life
