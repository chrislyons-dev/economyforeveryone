...
legacyPostRef: '2_ai-impact/2026-05-05-the-creators-gate'
triage: 'promote-to-canonical'
oneSmallAction: 'Pick one platform that controls your primary discovery path and check its current policy on AI labeling, training-data opt-out, and human review.'
audience:
  - 'creators'
  - 'writers'
  - 'artists'
...
- [Case Study: Creator Backlash, Betrayal, and Authenticity Collapse](/case-studies/creator-backlash-authenticity-collapse/)
- [Case Study: Content Flood and the Gate Shift](/case-studies/content-flood-gate-shift/)
