...
bucket: 'stress-test'
corePattern: 'When AI drops production cost to near-zero, the gate moves from production to distribution and trust. Whoever controls distribution and trust holds a decisive choke point.'
...
- [1. One scene, two pressures](#1-one-scene-two-pressures)
