...
- [8. Appeal effectiveness and the reversal rate problem](#8-appeal-effectiveness-and-the-reversal-rate-problem)
- [9. Governance lag and what enforceable looks like](#9-governance-lag-and-what-enforceable-looks-like)
- [10. Safety and reliability overreach](#10-safety-and-reliability-overreach)
- [11. What good looks like](#11-what-good-looks-like)
- [12. What to do](#12-what-to-do)
- [13. How to talk about it](#13-how-to-talk-about-it)
- [14. Where this analysis has limits](#14-where-this-analysis-has-limits)
...
- _Current state:_ Confirmed for time-per-case (Cigna PxDx: 1.2 sec/claim). Confirmed for throughput incentives (Cigna scorecards; CVS projection revision). Confirmed for automation bias (Stanford/Health Affairs 2025). Override rates: not disclosed in reviewed systems.
