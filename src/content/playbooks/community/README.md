...
This is for people who want to be useful without becoming a full-time policy person.
The job is not to solve everything.
The job is to pick one pressure point, ask for one real change, and stay on it long enough to learn something.
