---
title: 'Civics Playbooks (Core + Adapters)'
...
- [02 Candidate Evaluation + Feedback](./core/02-candidate-evaluation-and-feedback.md)
- [03 Voting Plan](./core/03-voting-plan.md)
- [04 Relational Canvassing](./core/04-relational-canvassing.md)
- [05 GOTV Micro-Team](./core/05-gotv-micro-team.md)
- [06 Public Meeting](./core/06-public-meeting.md)
- [07 Public Comment + Rulemaking](./core/07-public-comment-and-rulemaking.md)
- [08 Accountability (Watchdog Lite)](./core/08-accountability-watchdog-lite.md)
- [09 Coalition Basics](./core/09-coalition-basics.md)
- [10 Donations with Discipline](./core/10-donations-with-discipline.md)
- [11 Mutual Aid + Rapid Response](./core/11-mutual-aid-and-rapid-response.md)
- [12 Information Hygiene](./core/12-information-hygiene.md)
- [13 Office Hours Playbook](./core/13-office-hours.md)
- [14 Budget Season Playbook](./core/14-budget-season.md)
- [15 Procurement and Contract Guardrails](./core/15-procurement-and-contract-guardrails.md)
...
- [Local adapter](./adapters/local.md)
- [State adapter](./adapters/state.md)
- [Federal adapter](./adapters/federal.md)

### Templates

- [One Ask template](./templates/one-ask-template.md)
- [Civics log](./templates/civics-log.md)
- [90-second testimony](./templates/testimony-90-seconds.md)
- [Public comment template](./templates/public-comment-template.md)
- [Outreach / correction DM scripts](./templates/outreach-dm-scripts.md)
- [Office hours request email](./templates/office-hours-email.md)
- [Follow-up email](./templates/follow-up-email.md)
- [Budget testimony pack](./templates/budget-testimony-pack.md)
- [Target map](./templates/target-map.md)
- [Case file intake](./templates/case-file-intake.md)
- [Weekly checklist](./templates/civics-weekly-checklist.md)
- [Contract clause snippets](./templates/contract-clause-snippets.md)
- [Coalition minimum agreement](./templates/coalition-minimum-agreement.md)
...
- [Local](./adapters/local.md) / [State](./adapters/state.md) / [Federal](./adapters/federal.md)
...
1. **One Ask**: rule + owner + metric + deadline
2. **One Channel**: email, meeting testimony, docket comment, oversight office, or office hours
3. **One Follow-up date**: on the calendar
4. **One Log entry**: what you did, what happened, next step

Use the [One Ask template](./templates/one-ask-template.md) and [Civics log](./templates/civics-log.md) by default.

---

## Core playbooks (the starter set)

These are intentionally repeatable.
Same moves, different targets.
...
- [Public Meeting](./core/06-public-meeting.md)
- [One-Ask Engine](./core/01-one-ask-engine.md)
- [Accountability (Watchdog Lite)](./core/08-accountability-watchdog-lite.md)
- [Budget Season Playbook](./core/14-budget-season.md)
...
- [Public Comment + Rulemaking](./core/07-public-comment-and-rulemaking.md)
- [Candidate Evaluation + Feedback](./core/02-candidate-evaluation-and-feedback.md)
- [One-Ask Engine](./core/01-one-ask-engine.md)
- [Budget Season Playbook](./core/14-budget-season.md)
...
- [Public Comment + Rulemaking](./core/07-public-comment-and-rulemaking.md)
- [Accountability (Watchdog Lite)](./core/08-accountability-watchdog-lite.md)
- [Donations with Discipline](./core/10-donations-with-discipline.md) (if you're choosing leverage orgs)
...
Use the [weekly checklist](./templates/civics-weekly-checklist.md) if you want a default rhythm.
...
4. Check overview links and template references when files move or new playbooks get added.
