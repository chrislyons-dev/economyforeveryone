...
This package exists because the early labor risk from AI is not only displacement.
It is ladder collapse: entry narrows, learning work disappears, review turns ceremonial, and future human oversight gets weaker.
...
Most of the risk here is not a brand-new labor problem.
It is an old one running at new speed: weak entry pathways, overloaded reviewers, and short-term staffing logic all become easier to scale when AI removes learning work faster than organizations replace it.
...
- [Hiring Pipeline Protection](./01-hiring-pipeline-protection.md)
- [Learning Work Allocation](./02-learning-work-allocation.md)
- [Review Capacity and Oversight](./03-review-capacity-and-oversight.md)
- [Workforce Strategy and Bench Health](./04-workforce-strategy-and-bench-health.md)
...
- [Quarterly Bench Health Review](./templates/quarterly-bench-health-review.md)

## How the playbooks fit together

- [Career Ladder Protection Standard](./00-career-ladder-protection-standard.md) sets the non-negotiables
- [Hiring Pipeline Protection](./01-hiring-pipeline-protection.md) protects the first rung at entry
- [Learning Work Allocation](./02-learning-work-allocation.md) protects the reps that build judgment
- [Review Capacity and Oversight](./03-review-capacity-and-oversight.md) keeps human review meaningful as AI output rises
- [Workforce Strategy and Bench Health](./04-workforce-strategy-and-bench-health.md) keeps the longer-term bench visible in planning
- [Human Command in Employment Decisions](../ai-governance/human-command-in-employment-decisions.md) sets the due-process floor when AI affects worker opportunity or consequences
...
1. [Career Ladder Protection Standard](./00-career-ladder-protection-standard.md)
2. [Learning Work Allocation](./02-learning-work-allocation.md)
3. [Workforce Strategy and Bench Health](./04-workforce-strategy-and-bench-health.md)

Why:
the first damage usually shows up in work design, thinning review, and quiet senior-skewed hiring long before anyone writes down a formal policy.
...
Use [Quarterly Bench Health Review](./templates/quarterly-bench-health-review.md) to turn those signals into a recurring operating review instead of a loose list.
